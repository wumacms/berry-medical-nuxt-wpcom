...
const menuItems = [
  ...
  { id: "rights", title: "五、您的法定权利" },
  { id: "contact", title: "六、联系我们" },
];
</script>
  ...
  <div class="page-privacy">
    ...
    <div class="max-w-[1200px] mx-auto px-5 mb-16">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <!-- 侧边目录 -->
        <aside class="lg:col-span-3 bg-white border border-gray-200 rounded-sm p-5 sticky top-24 shadow-xs">
        ...
        <!-- 正文 -->
        <main class="lg:col-span-9 bg-white border border-gray-200 rounded-sm p-6 sm:p-10 shadow-xs">
          <p class="text-xs text-gray-400 mb-6">更新日期：2026年9月23日</p>

          <section id="collect" class="mb-8 scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">一、我们收集的信息</h2>
          ...
          <section id="use" class="mb-8 scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">二、信息的使用方式</h2>
            <p class="text-[14px] text-gray-600 leading-[1.8] font-normal m-0">
          ...
          <section id="share" class="mb-8 scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">三、信息的共享与披露</h2>
            <p class="text-[14px] text-gray-600 leading-[1.8] font-normal m-0">
          ...
          <section id="store" class="mb-8 scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">四、信息的存储与保护</h2>
            <p class="text-[14px] text-gray-600 leading-[1.8] font-normal m-0">
          ...
          <section id="rights" class="mb-8 scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">五、您的法定权利</h2>
            <p class="text-[14px] text-gray-600 leading-[1.8] font-normal m-0">
          ...
          <section id="contact" class="scroll-mt-24">
            <h2 class="text-lg sm:text-xl font-semibold text-[#262626] mb-3 pl-3 border-l-4 border-[#206be7]">六、联系我们</h2>
            <p class="text-[14px] text-gray-600 leading-[1.8] font-normal m-0">
